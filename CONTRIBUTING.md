...
When you have a bug report or feature request or something, please create an issue from [here](https://github.com/gocommunity-io/terraform-provider-dockerd/issues/new/choose).
...
```sh
git clone git@github.com:gocommunity-io/terraform-provider-dockerd.git
```
...
export TESTING_MIRROR=testing-mirror/registry.terraform.io/gocommunity-io/dockerd/9.9.9/$(go env GOHOSTOS)_$(go env GOHOSTARCH)
